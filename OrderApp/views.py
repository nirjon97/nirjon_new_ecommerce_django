...
from .models import ShopCart,ShopingCartForm,OderForm,OderProduct,Order
            ...
            if control == 1:
              #  data = ShopCart.objects.filter(
               ...
               # data.quantity += form.cleaned_data['quantity']
                #data.save()
             messages.success(request, 'Your Product  has been already added')
